...
This folder contains the second standalone model pipeline for behavior classification.

## Goal
- Build an LSTM-based classifier.
...
```powershell
python ai-service/model_behavior/lstm_model/train_eval_lstm_kmeans.py
```

Or with custom data path:

```powershell
python ai-service/model_behavior/lstm_model/train_eval_lstm_kmeans.py --data "ai-service/data/model_behavior/data_user500.csv"
```
